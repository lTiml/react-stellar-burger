...
import { orders, total, totalInDay } from '../../services/selectors/selectors';
...
export const FeedPage = () => {
	...
	const totalInDayFeed = useSelector(totalInDay);
	...
	return (
		<div className={styles.container}>
			...
			<div className={styles.content}>
				...
				<FeedOrders total={totalFeed} totalInDay={totalInDayFeed} orders={ordersFeed}/>
			</div>
			{isLoading && <Loader/>}
		</div>
	)
